...
function NotificationPanel({ upcoming, overdue, onDismiss, npsAlerts, dismissNps, checkinOverdue, checkinUpcoming, rankUpgrades, onApproveRank, onRejectRank, attendanceAlerts, slackFailures, onSlackPosted }) {
  ...
  return (
    <div className="fixed inset-x-2 sm:inset-x-auto sm:absolute sm:left-0 top-16 sm:top-full sm:mt-2 z-50 overflow-hidden rounded-2xl"
...
function DailyPanel({ onClose }) {
  ...
  return (
    <div className="fixed inset-x-2 sm:inset-x-auto sm:absolute sm:left-0 top-16 sm:top-full sm:mt-2 z-50 rounded-2xl overflow-hidden" dir="rtl"
      style={{ width: 270, maxWidth: 'calc(100vw - 1rem)', background: 'rgb(var(--bg-elevated))', border: '1px solid rgba(255,255,255,0.12)', boxShadow: '0 20px 60px rgba(0,0,0,0.65)' }}>
...
function ToolsPanel({ onClose, isAdmin }) {
  ...
  return (
    <div className="fixed inset-x-2 sm:inset-x-auto sm:absolute sm:left-0 top-16 sm:top-full sm:mt-2 z-50 rounded-2xl overflow-hidden"
      style={{ width: 280, maxWidth: 'calc(100vw - 1rem)', background:'rgb(var(--bg-elevated))', border:'1px solid rgba(255,255,255,0.12)', boxShadow:'0 20px 60px rgba(0,0,0,0.65)' }}>
