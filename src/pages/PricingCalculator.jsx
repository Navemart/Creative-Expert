  ...
  return (
    <div style={{ position:'relative', display:'inline-flex', alignItems:'center' }}>
      <button
        ...
        style={{ width:18, height:18, borderRadius:'50%', background:C.accent, color:'#000', fontSize: '0.75rem', fontWeight:700, border:'none', cursor:'pointer', display:'inline-flex', alignItems:'center', justifyContent:'center', flexShrink:0, marginRight:6, lineHeight:1 }}
      >?</button>
      {show && (
