...
const DEFAULT_CONTENT = {
  ...
  reminderText: 'אל תנסה לעבוד על הכל בבת אחת. התקדמות אמיתית = שלב אחד בכל פעם. זיהית את צוואר הבקבוק שלך — עבוד רק עליו.',
  stages: {
    building: {
      dots: '🔴🔴',
      title: 'בונה',
      color: 'red',
      subtitle: 'אין עדיין הצעה ברורה',
      requirements: [
        { label: 'הצעה שמוכרת', ok: false },
        { label: 'זרימת פניות', ok: false },
      ],
      tags: ['הצעה', 'הוכחות', '3 מכירות'],
      feels: [
        'כל פרויקט נראה קצת אחרת — תמחור שונה, תהליך שונה, תוצרים שונים',
        'לפעמים יש עבודה, לפעמים שקט מוחלט ומפחיד',
        'אתה אומר "כן" לכל מה שמגיע, כי אתה לא בטוח שיבוא עוד',
      ],
      mistake: 'לנסות לעבוד על שיווק ולידים לפני שיש הצעה ברורה. זה כמו לפרסם חנות שעדיין לא ברור מה היא מוכרת.',
      focus: [
        'הצעה — הגדר תהליך אחד ברור שמוביל לתוצאה ספציפית',
        'הוכחות — בחר 2–3 עבודות גמורות והפוך אותן לקייסטאדיז שאפשר לפרסם',
        '3 מכירות — תוצא 3 עסקאות בהצעה החדשה לפני שאתה עובד על כל דבר אחר',
      ],
      question: 'מכרתי את אותה הצעה פעמיים, באותו מחיר, בלי לבנות אותה מחדש לכל לקוח?',
    },
    loaded: {
      dots: '🟢🔴',
      title: 'טעון',
      color: 'amber',
      subtitle: 'יש הצעה שעובדת | אין עדיין זרימת פניות עקבית',
      requirements: [
        { label: 'הצעה שמוכרת', ok: true },
        { label: 'זרימת פניות', ok: false },
      ],
      tags: ['פלטפורמה אחת', 'קצב קבוע', 'מעקב'],
      feels: [
        'כשמישהו מגיע, אתה יודע בדיוק מה להציע ואיך לתמחר — וזה עובד',
        'אבל הפניות מגיעות בגלים: חודש עמוס, חודש ריק, חודש עמוס, חודש ריק',
        'מתפוצץ בעבודה → מפסיק לפרסם → הצינור מתייבש → פאניקה → מתחיל מחדש',
      ],
      mistake: 'לשנות את ההצעה כל הזמן "כדי שיהיו יותר לידים". ההצעה עובדת — הבעיה היא ערוץ ההפצה, לא המוצר.',
      focus: [
        'פלטפורמה אחת — בחר אינסטגרם ולך אליה אול-אין',
        'קצב קבוע — הגדר מספר מינימלי של פוסטים/סטורי בשבוע ושמור עליו גם כשאתה עמוס',
        'מעקב — 4 שבועות רצופים: כמה פניות מגיעות? מאיפה?',
      ],
      question: 'יש לי מקור אחד שאני יכול להגיד עליו "זה מביא לי פניות קבועות בחודש"?',
    },
    spinning: {
      dots: '🟢🟢',
      title: 'מסתובב',
      color: 'green',
      subtitle: 'הצעה שעובדת + זרימת פניות עקבית',
      requirements: [
        { label: 'הצעה שמוכרת', ok: true },
        { label: 'זרימת פניות', ok: true },
      ],
      tags: ['מיפוי זמן', 'העברת שלב', 'נכס מותג'],
      feels: [
        'פניות מגיעות, אתה סוגר אותן, יש הכנסה יציבה',
        'אבל אתה התחנה היחידה — כל פרויקט עובר רק דרכך',
        'ההכנסה תלויה בשעות שלך, ויש לך רק 24 שעות ביום',
      ],
      mistake: 'לקחת עוד לקוחות כדי "להרוויח יותר". זה רק מגדיל את העומס, לא את הרווח לשעה.',
      focus: [
        'מפה איפה הזמן הולך — איפה אתה מבזבז שעות על דברים שלא חייבים להיות אתה?',
        'בחר דבר אחד להעביר — תבנית, צ׳קליסט, פרילנסר תומך, או אוטומציה',
        'בנה נכס מותג — הגדל את הזמן שלקוחות צורכים אותך גם כשאתה לא זמין',
      ],
      question: 'יש שלב אחד בתהליך שקורה בלי שאני מעורב ישירות?',
    },
    compounding: {
      dots: '🟢🟢🟢',
      title: 'מצטבר',
      color: 'blue',
      subtitle: 'הצעה + לידים + מינוף — הכל עובד',
      requirements: [
        { label: 'הצעה שמוכרת', ok: true },
        { label: 'זרימת פניות', ok: true },
        { label: 'מינוף', ok: true },
      ],
      tags: ['תמחור', 'בחירת לקוחות', 'חופש'],
      feels: [
        'פניות מגיעות, אתה סוגר, ויש לך מנגנון שמחזיר לך זמן',
        'לקוח חדש לא עולה לך בלילות ללא שינה',
        'אתה יכול לבחור לקוחות, לא רק לקבל את מי שמגיע',
      ],
      mistake: 'להרגיש "סיימתי" — אבל גם כאן יש עבודה: תמחור, בחירת לקוחות, וחופש אמיתי.',
      focus: [
        'תמחור — האם המחיר שלך משקף את התוצאה שאתה נותן, או עדיין את הזמן שלך?',
        'בחירה — האם אתה עובד עם הלקוחות שאתה רוצה, או עם מי שמגיע?',
        'חופש — האם החופש שהשגת מתורגם לחיים שאתה רוצה (זמן, יצירתיות, בריאות)?',
      ],
      question: 'אם אני לוקח שבוע חופש לגמרי, העסק ממשיך לתפקד?',
    },
  },
};
